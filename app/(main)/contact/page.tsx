    ...
    <div className="pt-24 pb-20">
      ...
      <div className="bg-dark text-white py-20 text-center">
        <div className="container mx-auto px-4">
          ...
          >
            We are here to help you build the perfect commercial kitchen. Reach out to our experts today.
          </motion.p>
        </div>
      </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input type="tel" name="phone" value={formData.phone} onChange={handleChange} className="w-full h-12 px-4 rounded-xl border border-gray-300 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="+91 070657 75520" />
                </div>
              </div>
              ...
              <Button type="submit" variant="primary" size="lg" className="w-full md:w-auto">Send Message</Button>
            </form>
          </motion.div>
